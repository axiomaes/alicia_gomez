...
// Mismo helper que apps/web/src/components/TablerIcon.tsx -- duplicado
// aquí porque admin y web son apps separadas sin paquete compartido en
// este repo. El nombre guardado en `content` (p. ej. "Gavel",
// "BuildingBank") es directamente el sufijo del componente exportado por
// @tabler/icons-react ("IconGavel", "IconBuildingBank").
