...
// Calco de apps/admin/src/app/dashboard/blogs/new/page.tsx.
export default function NewKbArticlePage() {
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-4">
          <Link href="/dashboard/knowledge-base" className="p-2 rounded-lg hover:bg-zinc-800 text-zinc-400 hover:text-white transition-colors">
            <ArrowLeft className="w-5 h-5" />
          </Link>
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-white">Nuevo Artículo</h1>
            <p className="text-zinc-400 mt-1">Escribe una nueva entrada para la Base de Conocimiento.</p>
          </div>
        </div>
      </div>

      <form action={saveKbArticle} className="bg-zinc-900/50 backdrop-blur-md border border-zinc-800 rounded-2xl p-8 space-y-6">
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              name="slug"
              required
              placeholder="ejemplo: como-pedir-cita-previa"
          ...
          <div>
            ...
            <textarea
              name="excerpt"
              rows={2}
              placeholder="Una breve descripción para mostrar en el listado..."
